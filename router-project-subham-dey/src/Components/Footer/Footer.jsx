...
export default function Footer() {
  ...
  const data4 = [
    ...
    "& refurbished headphones while",
    "shopping online. Headphone Zone is a",
    "professionally run business & deals",
    "only in 100% genuine headphones.",
  ];
  ...
  return (
    <>
      ...
      >
        <Box>
          <Head heading={"LET US HELP YOU"} />
          {data1.map((el, i) => (
            <FText text={el} key={i} />
          ))}
        </Box>
        <Box>
          <Head heading={"OUR POLICIES"} />
          {data2.map((el, i) => (
            <FText text={el} key={i} />
          ))}
        </Box>
        <Box>
          <Head heading={"COMMUNITIES"} />
          {data3.map((el, i) => (
            <FText text={el} key={i} />
          ))}
        </Box>
        <Box>
          <Head heading={"BEWARE OF FAKES"} />
          {data4.map((el, i) => (
            <FText text={el} key={i} />
          ))}
        </Box>
        <Box>
          ...
          <Flex mt="20px">
            <Socials
              item={
                <svg focusable="false" width="9" height="17" viewBox="0 0 9 17">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
